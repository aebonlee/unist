import{u as n,j as e}from"./index-DzvBRcV1.js";import{G as o}from"./GuidePage-C1KC9Psq.js";import"./SEOHead-B_bVkK4k.js";const i={id:"module2-env",icon:"fa-cloud",title:"모듈 2 · 클라우드 기반 AI 분석 환경 구축",titleEn:"Module 2 · Cloud-based AI Analysis Environment",sections:[{title:"클라우드 vs 로컬, 그리고 Colab",titleEn:"Cloud vs Local, and Colab",content:`데이터 분석을 시작할 때 가장 먼저 부딪히는 질문은 **"어디서 코드를 돌릴 것인가"**입니다. 크게 **클라우드(Google Colab)**와 **로컬(내 PC에 직접 설치)** 두 가지 길이 있습니다. 비전공자·현장 실무자라면 **설치가 필요 없는 클라우드(Colab)로 시작**하는 것을 강력히 권합니다.
