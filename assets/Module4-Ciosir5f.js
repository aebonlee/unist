import{u as i,j as e}from"./index-FBdDRoI6.js";import{G as n}from"./GuidePage-BHjWa5Rv.js";import"./SEOHead-BdAQoTEc.js";const o={id:"module4-voc",icon:"fa-comments",title:"모듈 4 · 고객 반응 데이터 수집 및 분석",titleEn:"Module 4 · Voice of Customer Collection and Analysis",sections:[{title:"왜 고객 반응(VOC) 데이터인가",titleEn:"Why Voice of Customer Data",content:`이번 모듈은 **1시간 실습** 모듈입니다. 공정·센서 데이터를 넘어, 이번에는 **사람이 직접 남긴 데이터** — 즉 **고객의 목소리(VOC, Voice of Customer)**를 다룹니다. 앱스토어 리뷰를 자동으로 수집하고, 생성형 AI로 테마를 분류하고, 제품 개선 리포트까지 한 번에 완성하는 것이 목표입니다.
